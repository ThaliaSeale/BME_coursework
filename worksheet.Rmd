...
(To reiterate:) In healthy patients, mole widths are normally distributed with a mean of 6.0 mm, and the standard deviation of the sample mean from 10 moles is 0.2 mm. Suppose that in a particular patient, their mole width is normally distributed with a mean of 6.2 mm instead.
